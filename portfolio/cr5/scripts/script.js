...
function createCards() {
    ...
    let vaxxBtns = document.getElementsByClassName("vaxx-btn");
    let vaxxIcons = document.getElementsByClassName("vaxx-icon");
...
let imgTop = document.getElementsByClassName("card-img-top");
let visibility = false;
animals.forEach((obj, i) => {
    imgBtns[i].addEventListener("click", function () {
        let imgBtn = imgBtns[i];
        if (visibility == false) {
